...
<head>
    <script>
        ...
        if (account == null) {
            ...
            location.href = "https://bullrunultimate.github.io/signin";
        }
    </script>
    <!-- Meta data -->
    <meta charset="UTF-8">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://bullrunultimate.github.io/signup/assets/img/bullrun3.png">


    <!-- Title -->
    <title>BULLRUN ULTIMATE</title>

    <!-- Bootstrap css -->
    <link href="https://bullrunultimate.github.io/bootstrap.min.css" rel="stylesheet" />

    <!-- Style css -->
    <link href="https://bullrunultimate.github.io/css.style.css" rel="stylesheet" />

    <!-- Default css -->
    <link href="https://bullrunultimate.github.io/default.css" rel="stylesheet">

    <!-- Sidemenu css-->
    <link rel="stylesheet" href="https://bullrunultimate.github.io/sidemenu.css">

    <!-- Bootstrap-daterangepicker css -->
    <link rel="stylesheet" href="https://bullrunultimate.github.io/daterangepicker.css.html">

    <!-- Bootstrap-datepicker css -->
    <link rel="stylesheet" href="https://bullrun.live/Content/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.css">

    <!-- Custom scroll bar css -->
    <link href="https://bullrunultimate.github.io/jquery.mCustomScrollbar.css" rel="stylesheet" />

    <!-- Sidemenu-repsonsive-tabs  css -->
    <link href="https://bullrunultimate.github.io/sidemenu-responsive-tabs.css" rel="stylesheet">
            ...
            <div class="header-main header sticky">
                <div class="app-header header top-header navbar-collapse ">
                    <div class="container-fluid">
                        <div class="d-flex">
                            <a class="header-brand" href="https://bullrunultimate.github.io/Home-Dashboard">
                                <h3 style="margin-top: 16px;color: #141670;">BULLRUN ULTIMATE</h3>
                    ...
                    <div class="first-sidemenu">
                        <div class="line-animations">
                            <ul class="resp-tabs-list hor_1">
                                ...
                                <li class="autopool"><a href="https://bullrunultimate.github.io/Autopool"><span class="side-menu__icon"></span><img src="/m2.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Autopool"></a></li>
                                <li class="trans"><a href="https://bullrunultimate.github.io/Transaction"><span class="side-menu__icon"></span><img src="/m3.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Transations"></a></li>
                                <li class="team2"><a href="https://bullrunultimate.github.io/Team"><span class="side-menu__icon"></span><img src="/m4.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Team"></a></li>
                                <li class="media2"><a href="https://bullrunultimate.github.io/Media"><span class="side-menu__icon"></span><img src="/m5.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Media"></a></li>
...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://bullrunultimate.github.io/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').html("https://link.trustwallet.com/open_url?coin_id=60&url=https://bullrunultimate.github.io/signup?referralid=" + result1.id);



            $('.currentuseridlink').val("https://bullrunultimate.github.io/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https://bullrunultimate.github.io/signup?referralid=" + result1.id);



            $('.sharebutton').attr('data-url', "https://bullrunultimate.github.io/signup?referralid=" + result1.id);
                ...
                <div class="banner banner-color mt-0">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
                        <div class="socialjs">
                            ...
                            <a class="sharebutton facebook btn " style="background-color:#3b5998;color:white" data-basecount="" data-sharetype="facebook" data-text="The page title" title="Share this on Facebook" href="#" data-url="https://bullrunultimate.github.io/signup?referralid="><i class=" fa fa-facebook"></i></a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6  mt-2 mb-2 text-center">
                        Copyright © 2020 <a href="#" class="fs-14 text-primary">https://bullrunultimate.github.io</a>
                    </div>
                </div>
            </div>
        </footer>
